...
try:
    from v21_transformer_decoupled_bottleneck_gqa import GPT, ModelConfig, pick_device  # type: ignore[import]
except ImportError:
...
def test_retrieval(model: GPT, context: torch.Tensor,
    ...
    return success, confidence, predicted  # type: ignore[return-value]
...
def main():
    ...
    results = run_needle_haystack(
        model, device,  # type: ignore[arg-type]

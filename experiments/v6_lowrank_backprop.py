...
class LowRankLinearFn(torch.autograd.Function):
    ...
    This avoids ever constructing a full [out x in] weight matrix in the graph.
    """
...
# ============================================================
# ADAPTIVE LOW-RANK LAYER WITH CUSTOM BACKPROP
# ============================================================
...
class AdaptiveLowRankLayer(nn.Module):
    ...
    def forward(self, x):
        return LowRankLinearFn.apply(x, self.U, self.V)

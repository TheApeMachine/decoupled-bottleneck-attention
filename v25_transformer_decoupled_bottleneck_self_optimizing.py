#!/usr/bin/env python3
""" 
v25_transformer_decoupled_bottleneck_self_optimizing.py
...
"Survive scale" upgrades in this v25 variant:
...
class KVSelfOptConfig:
    ...
    # Optional correctness guardrail when comparing candidates (slow, but useful while bringing kernels up).
    verify: bool = False
...
class KVDecodeSelfOptimizer:
    ...
    def _save(self) -> None:
        ...
        try:
            ...
            raw = {k: asdict(v) for k, v in self._plans.items()}
...
def main() -> None:
    ...
    if args.mode == "sample":
        ...
        # v25 self-optimizer config (optional)

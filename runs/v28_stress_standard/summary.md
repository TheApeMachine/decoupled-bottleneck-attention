...
- Created: `2025-12-17T07:15:52+01:00`
- Out dir: `runs/v28_stress_standard`
- Device: `mps`
- Command: `v28_transformer_decoupled_bottleneck_instrumented.py --data fineweb_100m.tokens --data-format text --out-dir runs/v28_stress_standard --attn-mode standard --d-model 1024 --layers 12 --block 2048 --batch-size 1 --grad-accum 1 --optimizer lion --grad-checkpoint --instrument basic`
...
```json
{
  ...
  "opt_fused": false,
  "optimizer": "lion",
  "out_dir": "runs/v28_stress_standard",
  "param_dtype": "fp32",
  "print_config": false,
  "prompt_tokens": "0",
  "rope": false,

...
- Created: `2025-12-17T07:22:00+01:00`
- Out dir: `runs/v28_stress_fix`
- Device: `mps`
- Command: `v28_transformer_decoupled_bottleneck_instrumented.py --data fineweb_100m.tokens --data-format text --out-dir runs/v28_stress_fix --attn-mode standard --d-model 1024 --layers 12 --block 2048 --batch-size 1 --grad-accum 32 --optimizer lion --lr 1e-4 --grad-checkpoint --amp --amp-dtype bf16 --instrument basic`

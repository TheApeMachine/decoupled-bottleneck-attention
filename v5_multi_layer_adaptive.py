...
def update_layer_rank_from_grad(
    ...
    """
    Given an AdaptiveLowRankLayer with valid U.grad and V.grad,
    approximate full W.grad and update rank from largest gradient group.
    """
...
def train_one_epoch(
    ...
    for batch_idx, (inputs, targets) in enumerate(dataloader):
        ...
        # Once per epoch, based on the first batch's gradients,
        # adapt ranks of both low-rank layers.
        if batch_idx == 0:
            update_layer_rank_from_grad(
                model.fc1,

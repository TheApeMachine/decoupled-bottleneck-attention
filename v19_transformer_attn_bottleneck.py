#!/usr/bin/env python3
# v11_transformer_attn_bottleneck.py
#
# A "first-principles" architectural probe motivated by ALRT findings:
#   - ALRT observed that Q/K projections in attention compress extremely hard
#     (mean rank ~11 out of 512), implying the *comparison subspace* used to
#     compute attention patterns is low-dimensional.
#     See ALRT report: Q/K compress most aggressively (mean rank 11.2).  fileciteturn1file2L14-L16
#
...
# fileciteturn1file4L4-L24
#
# USAGE (baseline-ish):
#   python3 v11_transformer_attn_bottleneck.py --wikitext2-dir ./wikitext-2
#
# USAGE (bottleneck attention, e.g. d_attn=128):
#   python3 v11_transformer_attn_bottleneck.py --wikitext2-dir ./wikitext-2 --attn-dim 128
#
# Logs:
...
class GPTLM(nn.Module):
    def __init__(self, cfg: ModelConfig):
        ...
        # weight-tying is important for small models w/ big vocab
...
def main() -> None:
    ...
    print(f"Model: layers={cfg.n_layer}, d_model={cfg.n_embd}, heads={cfg.n_head}, d_ff={cfg.d_ff}, block={cfg.block_size}")
    print(f"Attention mod: attn_dim={cfg.attn_dim} (baseline={cfg.n_embd}), tie_qk={cfg.tie_qk}, null_attn={cfg.null_attn}, learned_temp={cfg.learned_temp}")
